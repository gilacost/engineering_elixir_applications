...
This repository contains the source code for the chapters of [*Engineering Elixir Applications*](https://pragprog.com/titles/beamops/engineering-elixir-applications/) book by Ellie and Pep. The book is published by Pragmatic Bookshelf.
...
- **[EC2 Import - Part 1](./the_production_environment_and_packer/01_ec2_import_01)**
- **[EC2 Import - Part 2](./the_production_environment_and_packer/01_ec2_import_02)**
- **[EC2 Import - Part 3](./the_production_environment_and_packer/01_ec2_import_03)**
- **[EC2 Import - Part 4](./the_production_environment_and_packer/01_ec2_import_04)**
- **[SG Import - Part 1](./the_production_environment_and_packer/02_sg_import_01)**
- **[SG Import - Part 2](./the_production_environment_and_packer/02_sg_import_02)**
- **[VPC and Subnet Config](./the_production_environment_and_packer/03_vpc_and_subnet_config)**
- **[Key Pair Import](./the_production_environment_and_packer/04_key_pair_import)**
- **[Bootstrap EC2](./the_production_environment_and_packer/05_boostrap_ec2)**
- **[Packer Introduction](./the_production_environment_and_packer/06_packer_intro)**
- **[Packer Refactor](./the_production_environment_and_packer/07_packer_refactor)**
- **[Final Version](./the_production_environment_and_packer/08_final_version)**
...
- **[Postgres Secret](./continuous_deployment_and_repository_secrets/01_postgres_secret)**
- **[Web Secrets - Part 1](./continuous_deployment_and_repository_secrets/02_web_secrets_01)**
- **[Web Secrets - Part 2](./continuous_deployment_and_repository_secrets/02_web_secrets_02)**
- **[SOPS](./continuous_deployment_and_repository_secrets/03_sops)**
- **[Secrets Decrypt Script](./continuous_deployment_and_repository_secrets/04_secrets_decrypt_script)**
- **[Convenience Script](./continuous_deployment_and_repository_secrets/05_convenience_script)**
- **[GitHub Secrets](./continuous_deployment_and_repository_secrets/06_github_secrets)**
- **[Deployment Action](./continuous_deployment_and_repository_secrets/07_deploy_action)**
- **[Contributing Workflow](./continuous_deployment_and_repository_secrets/08_contributing_workflow)**
...
- **[Custom Dashboard](./create_a_custom_promex_metric_and_grafana_alert/02_custom_dashboard)**
