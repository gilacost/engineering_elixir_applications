# START: enable_ec2_monitoring
# in modules/cloud/aws/compute/swarm/autoscaling.tf

# END: enable_ec2_monitoring
locals {
  asg_name = "swarm-asg"
...
# END: autoscaling_policies

# START: cloudwatch_alarms
...
# END: cloudwatch_alarms

# START: autoscaling_event_rule
...
# END: autoscaling_event_rule

# START: autoscaling_event_target
